...
public interface IClassGroupService {
    ClassGroup insertClassGroup(ClassGroupInsertDTO dto) throws ClassGroupAlreadyExists;
    ClassGroup updateClassGroup(ClassGroupUpdateDTO dto) throws EntityNotFoundException;
